...
},{"ngraph.forcelayout3d":11}],"4":[function (require,module,exports){
...
},{"../options.js":75,"./createLayout.js":3,"./messages.js":5,"ngraph.fromjson":17}],"5":[function (require,module,exports){
/**
...
function createLayout(graph, physicsSettings) {
  ...
  function initLink(link) {
    ...
    var fromBody = nodeBodies[link.fromId],
        ...
        spring = physicsSimulator.addSpring(fromBody, toBody, link.length, link.weight);
...
},{"ngraph.events":8,"ngraph.physics.simulator":22}],"11":[function (require,module,exports){
/**
...
},{"./lib/bounds":12,"./lib/createBody":13,"./lib/dragForce":14,"./lib/eulerIntegrator":15,"./lib/springForce":16,"ngraph.forcelayout":10,"ngraph.merge":20,"ngraph.quadtreebh3d":48}],"12":[function (require,module,exports){
...
},{"ngraph.random":52}],"13":[function (require,module,exports){
...
},{"ngraph.physics.primitives":21}],"14":[function (require,module,exports){
/**
...
},{"ngraph.expose":9,"ngraph.merge":20}],"15":[function (require,module,exports){
/**
...
},{"ngraph.expose":9,"ngraph.merge":20,"ngraph.random":52}],"17":[function (require,module,exports){
module.exports = load;
...
},{"ngraph.graph":19}],"19":[function (require,module,exports){
/**
...
function createGraph(options) {
  ...
  function addLink(fromId, toId, data, weight, length) {
    enterModification();

    var fromNode = getNode(fromId) || addNode(fromId);
    var toNode = getNode(toId) || addNode(toId);

    var link = createLink(fromId, toId, data, weight, length);
  ...
  function createSingleLink(fromId, toId, data, weight, length) {
    var linkId = makeLinkId(fromId, toId);
    return new Link(fromId, toId, data, linkId, weight, length);
  }

  function createUniqueLink(fromId, toId, data, weight, length) {
 ...
 */
function Link(fromId, toId, data, id, weight, length) {
  this.fromId = fromId;
  this.toId = toId;
  this.data = data;
  this.id = id;
...
},{"ngraph.events":8}],"20":[function (require,module,exports){
...
},{"./lib/bounds":23,"./lib/createBody":24,"./lib/dragForce":25,"./lib/eulerIntegrator":26,"./lib/spring":27,"./lib/springForce":28,"ngraph.events":8,"ngraph.expose":9,"ngraph.merge":20,"ngraph.quadtreebh":44}],"23":[function (require,module,exports){
module.exports = function (bodies, settings) {
  var random = require('ngraph.random').random(42);
...
},{"ngraph.random":52}],"24":[function (require,module,exports){
var physics = require('ngraph.physics.primitives');
...
},{"ngraph.expose":9,"ngraph.merge":20}],"26":[function (require,module,exports){
/**
...
},{"ngraph.expose":9,"ngraph.merge":20,"ngraph.random":52}],"44":[function (require,module,exports){
/**
...
},{}],"40f042e9":[function anonymous(require
/**/) {
var f = require("4");(f.default ? f.default : f)(self);
},{"4":"4"}]},{},["40f042e9"])