...
function physicsSimulator(settings) {
  ...
  var publicApi = {
    ...
    step: function () {
      accumulateForces();
      totalMovement = integrate(bodies, settings.timeStep, buffer, lastStable);

      buffer = bounds.update();

      // var stableNow = totalMovement < settings.stableThreshold;
      var stableNow = totalMovement < 9000; // totally arbitrary...
