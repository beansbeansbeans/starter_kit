...
function createGraph(options) {
  ...
  function addLink(fromId, toId, data, weight) {
    enterModification();

    var fromNode = getNode(fromId) || addNode(fromId);
    var toNode = getNode(toId) || addNode(toId);

    var link = createLink(fromId, toId, data, weight);
  ...
  function createSingleLink(fromId, toId, data, weight) {
    var linkId = makeLinkId(fromId, toId);
    return new Link(fromId, toId, data, linkId, weight);
  }

  function createUniqueLink(fromId, toId, data, weight) {
 ...
 */
function Link(fromId, toId, data, id, weight) {
  this.fromId = fromId;
  this.toId = toId;
  this.data = data;
  this.id = id;
